...
#   set_location_assignment PIN_D2 -to TX_BUSY ;# SW[9]
...
#   set_location_assignment PIN_B2 -to LEDG[8] ;# LEDG[8]
   set_location_assignment PIN_B1 -to TX_BUSY ;# LEDG[9] 
...
#   set_location_assignment PIN_AB9  -to OS              ;# pin 20 LM75
#   set_location_assignment PIN_R16  -to GPIO1_CLKOUT[0] ;# pin 19
#   set_location_assignment PIN_V15  -to SCL             ;# pin 18 I2C on board (LM75)
#   set_location_assignment PIN_W15  -to GPIO1[12]       ;# pin 17
#   set_location_assignment PIN_T15  -to SDA             ;# pin 16 I2C on board (LM75)
